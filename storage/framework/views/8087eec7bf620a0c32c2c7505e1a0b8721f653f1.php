...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('YInD2u9')) {
    $componentId = $_instance->getRenderedChildComponentId('YInD2u9');
    $componentTag = $_instance->getRenderedChildComponentTagName('YInD2u9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YInD2u9');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('YInD2u9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\gig\gig-gridview.blade.php ENDPATH**/ ?>