...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('hdMAvMg')) {
    $componentId = $_instance->getRenderedChildComponentId('hdMAvMg');
    $componentTag = $_instance->getRenderedChildComponentTagName('hdMAvMg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hdMAvMg');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('hdMAvMg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\projects\search-projects.blade.php ENDPATH**/ ?>