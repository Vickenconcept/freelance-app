...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('9EsfLOF')) {
    $componentId = $_instance->getRenderedChildComponentId('9EsfLOF');
    $componentTag = $_instance->getRenderedChildComponentTagName('9EsfLOF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9EsfLOF');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('9EsfLOF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
