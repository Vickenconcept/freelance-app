...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('XsWd3n8')) {
    $componentId = $_instance->getRenderedChildComponentId('XsWd3n8');
    $componentTag = $_instance->getRenderedChildComponentTagName('XsWd3n8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XsWd3n8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('XsWd3n8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
...
} elseif ($_instance->childHasBeenRendered('SDmB1Lt')) {
    $componentId = $_instance->getRenderedChildComponentId('SDmB1Lt');
    $componentTag = $_instance->getRenderedChildComponentTagName('SDmB1Lt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SDmB1Lt');
} else {
    $response = \Livewire\Livewire::mount('seller.seller-portfolios', ['userProfileId' => $profile->id,'user_profile_id' => $profile->id]);
    $html = $response->html();
    $_instance->logRenderedChild('SDmB1Lt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
...
} elseif ($_instance->childHasBeenRendered('roUenbg')) {
    $componentId = $_instance->getRenderedChildComponentId('roUenbg');
    $componentTag = $_instance->getRenderedChildComponentTagName('roUenbg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('roUenbg');
} else {
    $response = \Livewire\Livewire::mount('seller.seller-education', ['userProfileId' => $profile->id,'user_profile_id' => $profile->id]);
    $html = $response->html();
    $_instance->logRenderedChild('roUenbg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
									<?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('cD1GPom')) {
    $componentId = $_instance->getRenderedChildComponentId('cD1GPom');
    $componentTag = $_instance->getRenderedChildComponentTagName('cD1GPom');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cD1GPom');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('cD1GPom', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
							</div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\sellers\profile.blade.php ENDPATH**/ ?>