...
} elseif ($_instance->childHasBeenRendered('R1mh4uX')) {
    $componentId = $_instance->getRenderedChildComponentId('R1mh4uX');
    $componentTag = $_instance->getRenderedChildComponentTagName('R1mh4uX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('R1mh4uX');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('R1mh4uX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\layouts\app.blade.php ENDPATH**/ ?>