...
} elseif ($_instance->childHasBeenRendered('e23SvpQ')) {
    $componentId = $_instance->getRenderedChildComponentId('e23SvpQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('e23SvpQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e23SvpQ');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('e23SvpQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\errors\minimal.blade.php ENDPATH**/ ?>