...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('BkrOyRS')) {
    $componentId = $_instance->getRenderedChildComponentId('BkrOyRS');
    $componentTag = $_instance->getRenderedChildComponentTagName('BkrOyRS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BkrOyRS');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('BkrOyRS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\gig\gig-listview.blade.php ENDPATH**/ ?>