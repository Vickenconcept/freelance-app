...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('wRlTfva')) {
    $componentId = $_instance->getRenderedChildComponentId('wRlTfva');
    $componentTag = $_instance->getRenderedChildComponentTagName('wRlTfva');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wRlTfva');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('wRlTfva', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
