...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('YpRsJSK')) {
    $componentId = $_instance->getRenderedChildComponentId('YpRsJSK');
    $componentTag = $_instance->getRenderedChildComponentTagName('YpRsJSK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YpRsJSK');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('YpRsJSK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('yddJE2b')) {
    $componentId = $_instance->getRenderedChildComponentId('yddJE2b');
    $componentTag = $_instance->getRenderedChildComponentTagName('yddJE2b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yddJE2b');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('yddJE2b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\livewire\project\project-activity.blade.php ENDPATH**/ ?>