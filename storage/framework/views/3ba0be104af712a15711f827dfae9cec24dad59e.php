...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('xMcQkUU')) {
    $componentId = $_instance->getRenderedChildComponentId('xMcQkUU');
    $componentTag = $_instance->getRenderedChildComponentTagName('xMcQkUU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xMcQkUU');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('xMcQkUU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                   <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('iaDtBiL')) {
    $componentId = $_instance->getRenderedChildComponentId('iaDtBiL');
    $componentTag = $_instance->getRenderedChildComponentTagName('iaDtBiL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iaDtBiL');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('iaDtBiL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
               </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('zE8rq0S')) {
    $componentId = $_instance->getRenderedChildComponentId('zE8rq0S');
    $componentTag = $_instance->getRenderedChildComponentTagName('zE8rq0S');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zE8rq0S');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('zE8rq0S', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.pagebuilder-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views/admin/pagebuilder.blade.php ENDPATH**/ ?>