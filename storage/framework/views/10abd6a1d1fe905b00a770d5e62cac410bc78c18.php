...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Z8cxy2D')) {
    $componentId = $_instance->getRenderedChildComponentId('Z8cxy2D');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z8cxy2D');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z8cxy2D');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Z8cxy2D', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                   <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('zCKKoXr')) {
    $componentId = $_instance->getRenderedChildComponentId('zCKKoXr');
    $componentTag = $_instance->getRenderedChildComponentTagName('zCKKoXr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zCKKoXr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('zCKKoXr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
               </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('RgwFWCm')) {
    $componentId = $_instance->getRenderedChildComponentId('RgwFWCm');
    $componentTag = $_instance->getRenderedChildComponentTagName('RgwFWCm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RgwFWCm');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('RgwFWCm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
