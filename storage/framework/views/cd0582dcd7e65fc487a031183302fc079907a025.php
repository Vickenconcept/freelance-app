...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ntA14EZ')) {
    $componentId = $_instance->getRenderedChildComponentId('ntA14EZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('ntA14EZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ntA14EZ');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ntA14EZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\sellers\search-sellers.blade.php ENDPATH**/ ?>