...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('UFhH0N7')) {
    $componentId = $_instance->getRenderedChildComponentId('UFhH0N7');
    $componentTag = $_instance->getRenderedChildComponentTagName('UFhH0N7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UFhH0N7');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('UFhH0N7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Ku09JOO')) {
    $componentId = $_instance->getRenderedChildComponentId('Ku09JOO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ku09JOO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ku09JOO');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Ku09JOO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                <?php endif; ?>            
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\gig\gig-activity.blade.php ENDPATH**/ ?>