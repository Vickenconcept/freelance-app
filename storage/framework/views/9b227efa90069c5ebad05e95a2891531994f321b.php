...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ChiuIai')) {
    $componentId = $_instance->getRenderedChildComponentId('ChiuIai');
    $componentTag = $_instance->getRenderedChildComponentTagName('ChiuIai');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ChiuIai');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ChiuIai', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('hPKk8qG')) {
    $componentId = $_instance->getRenderedChildComponentId('hPKk8qG');
    $componentTag = $_instance->getRenderedChildComponentTagName('hPKk8qG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hPKk8qG');
} else {
    $response = \Livewire\Livewire::mount('earnings.invoices', ['className' => 'tk-dbinvoice']);
    $html = $response->html();
    $_instance->logRenderedChild('hPKk8qG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('kTxyOzM')) {
    $componentId = $_instance->getRenderedChildComponentId('kTxyOzM');
    $componentTag = $_instance->getRenderedChildComponentTagName('kTxyOzM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kTxyOzM');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('kTxyOzM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\dashboard\dashboard.blade.php ENDPATH**/ ?>