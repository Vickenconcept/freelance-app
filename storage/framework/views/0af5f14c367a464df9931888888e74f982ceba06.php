...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('HVnFyrU')) {
    $componentId = $_instance->getRenderedChildComponentId('HVnFyrU');
    $componentTag = $_instance->getRenderedChildComponentTagName('HVnFyrU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HVnFyrU');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('HVnFyrU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </aside>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\New folder\taskup\resources\views\front-end\gig\gig-cart.blade.php ENDPATH**/ ?>